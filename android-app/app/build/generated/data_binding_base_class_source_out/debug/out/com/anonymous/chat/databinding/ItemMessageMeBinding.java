...
public final class ItemMessageMeBinding implements ViewBinding {
  @NonNull
  ...
  private ItemMessageMeBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ItemMessageMeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemMessageMeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_message_me, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemMessageMeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageMeBinding((LinearLayout) rootView, binding_audioPlayerView,
